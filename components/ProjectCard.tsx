...
const ProjectCard = ({ project }: Props) => {
  return (
    <div
      className="bg-primary-800 shadow-sm shadow-black rounded-md p-5
    transition duration-200 flex flex-col h-full ring-1 ring-primary-700 hover:ring-primary-600"
    >
